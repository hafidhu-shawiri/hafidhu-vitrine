          ...
          >
            <h3 className="m-0">
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-between gap-4 border-0 bg-transparent px-5 py-4 text-left text-[0.9375rem] font-semibold text-navy transition-colors hover:bg-ivory sm:px-6 sm:py-5 sm:text-[1rem]"
              >
                <span>{entry.q}</span>
                <Icon
                  name="chevron-down"
                  size={18}
                  className={cx(
                    'shrink-0 text-teal transition-transform duration-150',
                    isOpen && 'rotate-180'
                  )}
                />
              </button>
